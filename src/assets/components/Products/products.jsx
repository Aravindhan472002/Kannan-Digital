        ...
        <div>
          ...
          >
            {ProductsData.map((data) => (
              <div
                ...
                key={data.id}
                className="space-y-3 bg-white shadow-md p-4 rounded-lg hover:shadow-lg transition-shadow duration-300"
              >
                <img
                  src={data.img}
                  alt={data.title}
          ...
          <div className="flex justify-center">
            <button
              ...
              className="text-center mt-10 cursor-pointer bg-primary text-white py-1 px-4 rounded-md hover:bg-primary-dark"
            >
              View All Frames
            </button>
          </div>
